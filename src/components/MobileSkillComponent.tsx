...
export default function MobileSkillComponent() {
  ...
  return (
    <>
      ...
      <button onClick={() => router.push("/skill")} className="mt-10 py-5 px-5 items-center text-xl font-semibold lg:hidden border-2 border-white rounded-2xl bg-[linear-gradient(360deg,#254597,#282a61,#442965,#5f2d77,#a75170)] min-w-[clamp(160px,65vw,400px)]">
        View All Skills
        <Image src={NavigationRight} alt="View All Skills" width={20} height={20} className="inline-block ml-8" />  
      </button>
      </div>
    </>
  );
